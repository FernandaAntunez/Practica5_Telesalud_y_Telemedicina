...
**c) Log-energías y DCT (decorrelación)**
  ...
  * La **DCT-II** comprime y **decorrela**:
    $$c_m(q)=\sum_{j=1}^{J} L_m(j)\cos\Big(\tfrac{\pi}{J}q(j-\tfrac12)\Big) \quad q=0,\dots,Q-1$$
...
<p align="center">
  <img src="imagenes/matriz.png" alt="matriz" width="800">
</p>
...
<p align="center">
  <img src="imagenes/plot.png" alt="plot" width="800">
</p>
...
<p align="center">
  <img src="imagenes/porcentaje.png" alt="porcentaje" width="800">
</p>
