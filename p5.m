...
% 1 (Prác. 5): Selección Greedy por Área 
% El umbral debe ser 1.10
Amean  = mean(areas);
...
% 5: Construcción del dataset de rasgos MFCC por ciclo ===
...
% 6: Unir todos los datasets MFCC (Ejecutar por separado) ===
% Este bloque asume que ya has procesado MÚLTIPLES archivos y sus .mat están en la carpeta 'out/'.
...
if ~isempty(All)
    ...
    warning(" No se generó ningún dataset combinado (no se hallaron archivos MFCC).");
end
